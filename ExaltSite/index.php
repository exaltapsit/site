...
<html class="no-js" lang="">
      ...
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">
            <img alt="Brand" src="img/Logo.jpg" width="50px" height="50px"/>
          </a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          ...
          <li><a href="events.php" style=" line-height: 50px;">Events</a></li>
        </ul>
        </div><!--/.navbar-collapse -->
      </div>
    </nav>
    ...
    <div class="col-sm-6 div_size_img">
      <div class="hatcontainer" style="margin:50px;">
...

              {
                ...
                if($House!=NULL){
                  echo '<img src="img/'.$House.'.png" height="500px" width="500px" class="img_size">';
                  echo "<script> window.location.hash = '#HouseInfo' </script>";
                }
              }
              else{
                  echo '<img src="img/SortingHat.png" height="500px" width="500px" class="img_size">';
              }
            ?>
    ...
    <div class="col-sm-6 div_size_form">
      <center> <h3 style="line-height: 30px; letter-spacing: 0.5px;">Enter your moodle ID here to know which house you belong to !!! </h3> <br>
...

{
              ...
              echo '<br><div> <h3 style="line-height: 30px; letter-spacing: 0.5px;">Congratulations '.$Fullname.' <br> you belong to the '.$House.' House</h3> </div>';
}
